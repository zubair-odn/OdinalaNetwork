...
contract TwoStageCrowdsale is Ownable {
    PreICOCrowdsale public _preICOCrowdsale;
    ...
    function TwoStageCrowdsale(uint256 preICOStart, uint256 start, address wallet, uint256 releaseTime1, uint256 releaseTime2, uint256 releaseTime3) public {

        //preICOStart = 1599430994 06/09/2021
        //start = 1601510400
        //wallet = 0xb45E46CB39eA97Db36A8173C437673a859f938FC
        //releaseTime1 = 1630454400 1st sept 2021
        //releaseTime2 = 1661990400 1st sept 2022
        //releaseTime2 = 1696118399 1st sept 2023


        _token = createTokenContract();
        
        _stakingTimeLock = new StakingTimeLock(wallet, _token, 1614556800); //march 1st 2021
        
        _uniswapTimeLock = new UniswapTimeLock(wallet, _token, 1603584000); //25th October 2020
        
        _dexTimeLock = new DexTimeLock(wallet, _token, 1630454400); // 1 September 2021
        
        _preICOCrowdsale = new PreICOCrowdsale(
            wallet,
            _token,
            preICOStart
        );
        ...
        _devTimeLock = new DevTimeLock(wallet, _token, releaseTime1, releaseTime2, releaseTime3);
        
        _token.mint(wallet, 800000000000000000000000);
        _token.mint(_preICOCrowdsale, 1500000000000000000000000);
        _token.mint(_ICOCrowdsale, 1000000000000000000000000);
